...
NOT_ENOUGH_PARAMS = (
    '💥 Полученный в качестве обработчика метод должен принимать не менее '
    'двух параметров'
)
...
PARAM_IS_NOT_ANY = (
    '💥 Второй параметр метода обработки исключений должен быть типа '
    'Any, но не относится к данному типу'
)
